...
eas_2009_purpose_df <- pals_ongoing %>%
  filter(`DECISION TYPE` == "DN") %>%
...
write_csv(eas_projs, '/Users/katiemurenbeeld/Analysis/NEPA_EAs/data/processed/eas_proj_name_num_year_03-2023.csv')

write_csv(eas_projs_2009_purpose, "/Users/katiemurenbeeld/Analysis/NEPA_EAs/data/processed/eas_proj_01-2009_03-2023_purpose.csv")
